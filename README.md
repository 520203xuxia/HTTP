...
![Size](https://github.com/520203xuxia/HTTP/raw/master/img/Size.png)
	...
	以 https://blog.csdn.net/garrettzxd/article/details/80684880 网页举例分析
...
# 七、Https
## 1. 基础概念
	全称：Hyper Text Transfer Protocol over Secure Socket Layer，以安全为目标的HTTP通道，即HTTP下加入
	SSL层，HTTPS的安全基础是SSL，因此加密的详细内容就需要SSL。HTTPS使用端口443。
